...
if __name__ == '__main__':
    ...
    # Redirige la salida a un fichero llamado "datos.txt" utilizando los datos de "test_3.fasta"
    # formateando la secuencia a minuscula y las lineas de las secuencias serán
    # de un máximo de 3 carcateres
    secToTXT("datos.txt", "test_3.fasta", "minuscula", 3)